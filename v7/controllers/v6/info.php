...
class info extends MY_Controller {
    ...
    function softInfoXml(){
        ...
        if($os == 'ios'){
            ...
            echo json_encode(array('state' => '000', 'data' => array('version' => 31, 'versionName' => '3.20', 'description' => '3.20版本更新如下:
[Ver3.20/2015-08-05/13.30MB]
1、新增酷炫专题活动，一键发帖参与活动；
2、第三方账号登陆优化，想怎么登就怎么登；
3、第三方账号轻松绑定手机号，再也不怕找不到账号啦；
4、TA人中心展现更全面信息，让你更了解TA；
5、BUG当然越来越少了，我们追求零BUG。', 'path' => 'http://www.meilimei.com/m/meilishenqi.apk')));
        }
    }
