...
class diary extends CI_Controller {
    ...
    public function comments(){
        ...
        if ($start > 0)
            ...
            $offset = $start * $per_page;
        $data['results'] = $this->db->query("select nc.*,n.content as ncontent, n.imgurl as nimgurl,u.username,u.banned from note_comment nc left JOIN note n on nc.nid = n.nid left join users u on n.uid=u.id where 1=1 $sql order by nc.cid desc limit $offset , $per_page")->result();
        //echo '<pre>';
