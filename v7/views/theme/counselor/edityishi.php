            	...
            	<div class="institutions_info">
                    ...
                    <div class="Personal_center_right">
                    	...
                    	<div class="question_nav">
                        	<ul>
                            	<li class="on"><a href="#">修改管理</a> </li><li><a href="<?php echo site_url('counselor/similaryishi/') ?>">可能所属医师</a></li> <li><a href="<?php echo site_url('counselor/addyishi/') ?>">添加医师</a></li> 
                            </ul>
                        </div>
                         <div class="personal_information"><?php echo form_open_multipart("counselor/update"); ?>
                        	<ul><input class="inputbox" type="hidden" name="utype" value="2" />
                            	<li><input type="hidden" name="uid" value="<?php echo $uid ?>" />
                                    ...
                                    <div class="k2"> <?php if(!empty($yishi[0]['thumb'])){ ?><p><img id="thumbPic" src="<?php echo $yishi[0]['thumb'].'?'.time() ?>" width="120" ></p><?php }?><input type="file" name="thumb" /> </div>
                                </li>
                            	<li>
                                	<div class="k1">姓：</div>
