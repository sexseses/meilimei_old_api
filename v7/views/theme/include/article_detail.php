<link rel="stylesheet" type="text/css" href="http://static.meilimei.com.cn/public/css/new.css"> 
        ...
        <div class="page_left article_detail"><h6><a href="<?php echo site_url()?>">首页</a> >  <?php echo $results[0]['title'] ?></h6>
        <div  class="desc">
        ...
        <div class="page_right"><div class="leftboard"><h3>热门排行/TOP</h3>
<?php 
$i = 1;
foreach($infos as $r){
...
?>
 </div> <div class="leftboard"><img src="http://static.meilimei.com.cn/public/images/banners.png" /></div><div id="articlelist" ></div> 
