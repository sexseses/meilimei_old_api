                        ...
                        <div class="personal_information"><?php echo form_open("user/update"); ?>
                        	<ul>
                               ...
                               <li>
                                ...
                                </li><input class="inputbox" type="hidden" name="sourceemail" value="<?php echo $userinfo[0]['email'] ?>" />
                                <li>
                                ...
                                </select><select class="city" name="city" id="city"></select><select class="dist" name="district" id="district"></select> <input class="inputbox" type="text" name="address" value="<?php echo $userinfo[0]['address'] ?>" /></p></div>
                                </li>
                                <li>
                                	<div class="k1"> </div>
