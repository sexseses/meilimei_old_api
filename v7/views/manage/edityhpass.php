            	...
            	<div class="institutions_info new_institutions_info">
                    ...
                    <div class="manage_center_right">
                    	<div class="question_shortcuts">
                        	<ul>
                           <li><a href="<?php echo site_url('manage/users/detail/'.$uid) ?>">用户基本资料</a></li> <li class="selected"><a href="<?php echo site_url('manage/users/editpass/'.$uid) ?>">修改密码</a></li> <li><a href="<?php echo site_url('manage/users/follow/'.$uid) ?>">关注</a></li></a><li ><a href="<?php echo site_url('manage/users/track/'.$uid) ?>">跟踪纪录</a></li>
                            </ul>
                        </div>
                        <div class="personal_information"><?php echo form_open("manage/users/editpass"); ?>
                        	<ul> 
