  ...
  <div class="institutions_info new_institutions_info"> <?php  $this->load->view('manage/leftbar'); ?>
    <div class="manage_center_right">
                        ...
                        <div class="manage_yuyue" >
                            ...
                            <div><h5>问题信息</h5><br />【标题】<?php echo $qresults[0]->title ?> <br /> 【内容】<?php echo $qresults[0]->description  ;if(!empty($attaches)) echo '<br><img src="http://pic.meilimei.com.cn/upload/'.$attaches[0]['savepath'].'"/>';?>(时间:<?php echo date('Y-m-d H:i',$qresults[0]->cdate)?>) <br />咨询的医生: <a href="<?php echo site_url('manage/yishi/detail/'.$qresults[0]->toUid)?>"><?php echo $qresults[0]->alias ?></a> 
                            <br /> <?php
