            ...
            <div class="manage_yuyue">
                <div><?php echo form_open_multipart('manage/diary/addcategory') ?>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>发布的用户</td>
                                <td><input type="text" value="" name="user_id" id="user_id" /><input type="hidden" id="uid" name="uid" value="<?php echo $result[0]['uid'];?>" /></td>
                            </tr>
                            <tr>
                                <td>目录描述</td>

                                <td><textarea name="desc"><?php echo $result[0]['desc'];?></textarea> </td>
                            </tr>
                            <tr>
                                <td height="45">术前日期</td>
                                <td><input type="text" name="operation_time" id="operation_time" class="datepicker"  value="<?php  echo date('Y-m-d',$result[0]['operation_time']);?>"/>  </td>
                            </tr>
                            <tr>
                                <td>术前图片: </td>
                                <td><input type="file" name="noteCategoryPic" /><br/><img src="http://pic.meilimei.com.cn/upload/<?php echo $result[0]['imgurl'];?>" width="80px" height="100px"/></td>
                            </tr>
                            <tr>
                                <td>公开: </td>
                                <td><input type="radio" name="is" value="1" id="is1" <?php if($result[0]['is'] == 1){ echo 'checked';}?>/><label for="is1">公开</label><input type="radio" name="is" id="is0" value="0" <?php if($result[0]['is'] == 0){ echo 'checked';}?>/><label for="is0">隐藏</label></td>
                            </tr>
                            <tr>
                                <input type="hidden" name="type" value="2"/>
                                <input type="hidden" name="ncid" value="<?php echo $result[0]['ncid'];?>"/>
                                <td></td>
