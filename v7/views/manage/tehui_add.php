...
<div class="page_content937">
    <div class="institutions_info new_institutions_info">
        ...
        <div class="manage_center_right">
            ...
            ?>
            <?php echo form_open_multipart('manage/tehui/tehui_add',$attributes,$hidden); ?>
                ...
                <table>
                    <!-- <tr>
                        ...
                        <td>
                            ...
                            <input datatype="*" errormsg="请选择地区" nullmsg="请选择地区"  type="checkbox" name="city[]"   value="<?php echo $item['city'];?>" />
                    ...
                    <tr>
                        ...
                        <td>
                        <input type="input" name="tehuiid"  id="tehuiid" size="15" datatype="s5-16" /><span style="color:red">*</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="input" name="reser_price" class="file" id="reser_price" size="28" /><span style="color:red">*</span></td>
                    </tr>
                    <tr>
                        <td style="height:5px"></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="input" name="deposit" class="file"  size="28" /><span style="color:red">*</span></td>
                    </tr>
                    <tr>
                        <td style="height:5px"></td>
                        <td></td>
