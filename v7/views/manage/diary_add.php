                            ...
                            <td>
                                <table >
                                    ...
                                    <?php foreach($items_rs as $row){ ?>
                                        <tr class="childItem<?php echo $row['id']; ?>">
                                        ...
                                        <?php foreach($row['child'] as $child){ ?>
                                            <tr style="display:none;" class="childItem<?php echo $row['id']; ?>">
                                            ...
                                            <?php foreach($child['three_child'] as $three_child){ ?>
                                                <tr style="display:none;" class="threechildItem<?php echo $child['id']; ?>">
                                                    <td style="width:35%;text-align:center"><input type="radio" name="item_name" vlaue= "<?php echo $three_child['name'] ?>" /> <?php echo $three_child['name'] ?></td>
