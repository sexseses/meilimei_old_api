  ...
  <div class="institutions_info new_institutions_info"> <?php  $this->load->view('manage/leftbar'); ?>
    <div class="manage_center_right">
                    	<div class="question_nav">
                        	<ul>
                            	<li class="on"><a href="<?php echo base_url('manage/article')?>">文章管理</a></li><li><a href="<?php echo base_url('manage/article/add')?>">添加文章</a></li>
                            </ul>
                        </div>
                             ...
                             <?php 
								foreach($results as $row){
								  echo ' <ul>
                                    ...
                                    <li style="width:45%">'.$row->title .'</li> <li style="width:15%">'.$row->tag .'</li>
                                    <li style="width:15%">'.date('Y-m-d',$row->cdate) .'</li>  
								    <li style="width:10%"><a onclick="return confirm(\'确认删除 '.$row->title.'?\')" href="'.site_url('manage/article/del/'.$row->id).'">删除</a>  <a href="'.site_url('manage/article/edit/'.$row->id).'">编辑</a></li>
									 <div class="clear" style="clear:both;"></div>
                                </ul>';	
								}							
								 ?>
