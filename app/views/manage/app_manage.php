                        	...
                        	<div class="manage_yuyue_form">
                            	<ul>
                                    ...
                                    <li style="width:18%">名称</li>
                                     <li style="width:17%">附加信息</li>
                                    <li style="width:15%">版本</li> <li style="width:15%">影响版本</li>
                                    <li style="width:10%">更新时间</li> 
                             ...
                             <?php 
								foreach($results as $row){
								  echo ' <ul>
                                    ...
                                    <li style="width:18%">'.$row->name .'</li>
									<li style="width:17%">'.$row->extra .'</li>
									 <li style="width:15%">'.$row->version.'</li>
                                    <li style="width:15%">'.$row->effectver.'</li> 
									<li style="width:10%">'.date('Y-m-d',$row->cdate).'</li>  
								    <li style="width:10%"><a onclick="return confirm(\'确认删除 '.$row->name.'?\')" href="'.site_url('manage/app/del/'.$row->id).'">删除</a>  <a href="'.site_url('manage/app/edit/'.$row->id).'">编辑</a></li>
									 <div class="clear" style="clear:both;"></div>
                                </ul>';	
								}							
								 ?>
