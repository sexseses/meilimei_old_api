...
<div class="page_content937">
    <div class="institutions_info new_institutions_info">
        ...
        <div class="manage_center_right">
            ...
            ?>
            <?php echo form_open_multipart('manage/flashSale/IndexTopBanner_edit',$attributes,$hidden); ?>
        	<div class="manage_yuyue">
                <table>
                    <tr>
                        <td width="100">闪购编号：</td>
                        <td><input type="input" name="tehui_id"  id="" size="28" value="<?php echo $banner_rs['tehui_id'] ; ?>"/><span style="color:red">*</span></td>
                    </tr>
                    <tr height="20">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="input" name="begin"  id="begin" size="28" value="<?php echo date('Y-m-d',$banner_rs['begin']); ?>" /> - <input type="input" name="end"  id="end" size="28" value="<?php echo date('Y-m-d',$banner_rs['begin']); ?>"/>
                        </td>
                    </tr>
                    <tr height="20">
