        	...
        	<div class="manage_yuyue">
                <table>
                    <tr>
                        ...
                        <td>
                        <input type="input" name="event_name"  id="tehuiid" size="30" datatype="s5-16" /><span style="color:red">*</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="input" name="begin" class="file" id="begin" size="28" />-<input type="input" name="end" class="file" id="end" size="28" /><span style="color:red">*</span></td>
                    </tr>
                    <tr>
                        <td style="height:5px"></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="input" name="subject" class="file"  size="50" /><span style="color:red">*</span></td>
                    </tr>
                    <tr>
                        <td style="height:5px"></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="input" name="price" class="file"  size="20" /><span style="color:red">*</span></td>
                    </tr>
                    <tr>
                        <td style="height:5px"></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><textarea name="sms"></textarea><span style="color:red">*</span></td>
                    </tr>
                    <tr>
                        <td></td>
