  ...
  <div class="institutions_info new_institutions_info"> <?php  $this->load->view('manage/leftbar'); ?>
    <div class="manage_center_right">
                        ...
                        <div class="manage_yuyue" >
                        	<div class="manage_search"><?php echo form_open('manage/tuijian/yiyuan'); ?>
                            	<ul> 
                                    <li>医院名称<input name="sname" type="text" value="<?php echo $this->input->post('sname') ?>"></li>
                                     <li>城市<input name="city" type="text" value="<?php echo $this->input->post('city') ?>"></li>
                                    <li>电话号码<input name="tel" type="text" value="<?php echo $this->input->post('tel') ?>"></li>
                                    <li><input name="submit" type="submit" value="搜索" class="search"></li>
                                </ul></form>
                            </div>
                        	<div class="manage_yuyue_form">
                            	<ul>
                                	<li class="Vertical17">医院名称</li>
								...
								foreach($data as $row){
                                    ...
                                    <li class="Vertical19">'.$row['tel'].'</li>
