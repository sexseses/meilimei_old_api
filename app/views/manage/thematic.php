  ...
  <div class="institutions_info new_institutions_info"> <?php  $this->load->view('manage/leftbar'); ?>
    <div class="manage_center_right">
                    	<div class="question_nav">
                        	<ul>
                            	<li class="on"><a href="<?php echo base_url('manage/thematic')?>">专题管理</a></li><li><a href="<?php echo base_url('manage/thematic/add')?>">添加专题</a></li>
                            </ul>
                        </div>
                        <div class="manage_yuyue" >
                        	<div class="manage_search" style="display:none"><?php echo form_open('manage/yishi'); ?>
                            	<ul> 
                             ...
                             <?php 
								foreach($results as $row){
								  echo ' <ul>
								    ...
								    <li style="width:10%"><a onclick="return confirm(\'确认删除 '.$row->title.'?\')" href="'.site_url('manage/thematic/del/'.$row->id).'">删除</a>  <a href="'.site_url('manage/thematic/edit/'.$row->id).'">编辑</a></li>
									 <div class="clear" style="clear:both;"></div>
                                </ul>';	
								}							
								 ?>
