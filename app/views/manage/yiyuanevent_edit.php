...
<div class="page_content937">
    <div class="institutions_info new_institutions_info">
        ...
        <div class="manage_center_right">
            ...
            ?>
            <?php echo form_open_multipart('manage/yiyuanevent/event_edit/{$event_id}',$attributes,$hidden); ?>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php 
                                if(in_array($item['city'], unserialize($row['area']))) { 
                    ...
                    <tr>
                        ...
                        <td><input type="file" name="banner_path" class="file" id="fileField" size="28" /><span style="color:red">*</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="100">活动剩余时间：</td>
                        <td><input type="input" name="countdown"  id="" size="28" /><span style="color:red">*</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="file" name="event_pic" class="file" id="fileField" /><span style="color:red">*</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="100">真实点赞数：</td>
                        <td>
                            <input type="input" name="real_support"  id="" size="28" readonly="readonly"/>
                        </td>
                    </tr>
                    <tr>
