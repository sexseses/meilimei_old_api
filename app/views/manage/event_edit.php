...
<div class="page_content937">
    <div class="institutions_info new_institutions_info">
        ...
        <div class="manage_center_right">
            ...
            ?>
            <?php echo form_open_multipart('manage/event/edit',$attributes,$hidden); ?>
        	...
        	<div class="manage_yuyue">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="input" name="begin" class="file" id="begin" size="28" value="<?php echo date('Y-m-d',$event_rs['begin_time']); ?>"/>-<input type="input" name="end" class="file" id="end" size="28" value="<?php echo date('Y-m-d',$event_rs['end_time']); ?>"/><span style="color:red">*</span></td>
                    </tr>
                    <tr>
                        <td style="height:5px"></td>
                        <td></td>
