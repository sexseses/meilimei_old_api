  ...
  <div class="institutions_info"> <?php  $this->load->view('manage/leftbar'); ?>
    <div class="manage_center_right">
                        ...
                        <div class="manage_yuyue" >   
                            ...
                            <ul style="padding:10px;"><li style="padding:10px;"><label style="width:100px; display:inline-block">标题*</label><input name="title" type="text"  style="padding:2px;" value="" size="45" /></li><li style="padding:10px;"><label style="width:100px; display:inline-block">缩略图*</label><input name="picture" type="file"  size="45" /></li><li style="padding:10px;"><label style="width:100px; display:inline-block">标识(使用,分隔)*</label><input name="tags" type="text"  style="padding:2px;" value="" size="45" /></li><li style="padding:10px;"><label style="width:100px; display:inline-block">描述*</label><textarea style="width:550px" name="dec"></textarea> </li><li style="padding:10px;"><label style="width:100px; display:inline-block">来源*</label><input name="laiyuan" type="text"  style="padding:2px;" value="转载" size="45" /></li>
  
                            <li style="padding:10px;"><label style="width:100px; display:inline-block">手机字体适配*</label>苹果<input type="checkbox" name="moblile[]" value="apple"/>安卓<input type="checkbox" name="moblile[]" value=andriod/></li>
