            ...
            <div class="manage_yuyue">
                <div class="comments"><?php echo form_open_multipart('manage/apple/add'); ?>
                    ...
                    <table style="line-height:240%;">
                        ...
                        <tr>
                            <td><b style="width: 100px;" class="list_title">活动时间：</b></td><td>
                                <ul>
                                    <li><input name="b_time" type="text" style="padding:2px;" value="<?php echo  date('Y-m-d',@$row['bdate']); ?>" size="10" class="datepicker"/>-<input name="e_time" type="text" style="padding:2px;" value="<?php echo date('Y-m-d',@$row['edate']); ?>" size="10" class="datepicker"/></li>
                                </ul>
                            </td>
                        </tr>
