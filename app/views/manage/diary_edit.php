                        ...
                        <tr style="width:560px; ">
                            ...
                            <td >
                                ...
                                <div class="swipe" style="width:480px; float:left;">
                                    <div id="cropContainerModal" style="border: 1px solid #ccc; height: 480px; position: relative; width: 480px;" ><img src="<?php echo $result[0]->imgurl;?>" class="croppedImg" style="height: 480px;width: 480px;"></div>
                                    <div class="drag" style="top: <?php echo $result[0]->pointY.'%';?>; left: <?php echo $result[0]->pointX.'%';?>">1</div>
                                </div>
                                <div style="float: left; margin-left:20px" >
                                    <input type="hidden" name="filepath" id="filepath" value="<?php echo $result[0]->imgurl;?>" style="width:280px; padding:3px 5px"/>
