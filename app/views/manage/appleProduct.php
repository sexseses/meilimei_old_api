        ...
        <div class="manage_center_right">
            <div class="question_nav">
                <ul>
                    ...
                    <li class="on"><a href="<?php echo base_url('manage/apple/linksproduct')?>">外链产品</a></li>
                    <li><a href="<?php echo base_url('manage/apple/addlink')?>">添加外链产品</a></li>
                </ul>
            </div>
            <div class="manage_yuyue">
                <div class="manage_search"><?php echo form_open('manage/apple/linksproduct'); ?>
                    <ul>
                ...
                <div class="manage_yuyue_form">
                    ...
                    foreach ($results as $row) {   
						...
						<li style="width:10%">' . $row['price'] . '</li> 
						<li style="width:10%">' . $row['views'] . '</li> 
						<li style="width:10%">' . date('Y-m-d',$row['cdate']) . '</li> 
                        <li style="width:10%"> <a href="' . site_url('manage/apple/dellink/' . $row['id']) . '">删除</a>
						
						<a href="' . site_url('manage/apple/editlink/' . $row['id']) . '">编辑</a>
						</li>
                        <div class="clear" style="clear:both;"></div>
                        </ul>';
                    }
