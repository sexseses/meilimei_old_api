    ...
    <div class="manage_center_right">
                        ...
                        <div class="manage_yuyue" >
                        	...
                        	<div class="manage_yuyue_form">
								...
								foreach($res as $row){ 
									echo '<ul>
                                	<li style="width:20%"><a target="_blank" href="http://tieba.baidu.com'.$row['url'].'" >'.$row['url'].'</a></li>
                                  	<li style="width:45%">'.$row['title'].'</li>
                                  	<li style="width:15%">'.date('Y-m-d H:i',$row['cdate']).'</li>
                                   <li style="width:10%"><a onclick="return confirm(\'确认删除 '.$row['id'].'?\')" href="'.base_url('manage/spider/topicdel/'.$row['id']).'" >删除</a>   <a href="'.base_url('manage/spider/topicEdit/'.$row['id']).'">编辑</a></li>
