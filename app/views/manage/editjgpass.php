            	...
            	<div class="institutions_info">
                    ...
                    <div class="Personal_center_right">
                    	<div class="question_shortcuts">
                        	<ul>
                           <li><a href="<?php echo site_url('manage/yiyuan/detail/'.$uid) ?>">医院基本资料</a></li> <li class="selected"><a href="<?php echo site_url('manage/yiyuan/editpass/'.$uid) ?>">修改密码</a></li> 
                            </ul>
                        </div>
                        <div class="personal_information"><?php echo form_open("manage/yiyuan/editpass"); ?>
                        	<ul> 
