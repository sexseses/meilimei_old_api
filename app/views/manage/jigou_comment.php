  ...
  <div class="institutions_info new_institutions_info"> <?php  $this->load->view('manage/leftbar'); ?>
    <div class="manage_center_right">
                    	<div class="question_nav">
                        	<ul>
                            	<li><a href="<?php echo site_url('manage/yiyuan/detail/'.$acuid) ?>">医院机构基本资料</a></li> <li><a href="<?php echo site_url('manage/yiyuan/editpass/'.$acuid) ?>">修改密码</a></li>  <li class="on"><a href="<?php echo site_url('manage/yiyuan/comment/'.$acuid) ?>">评价</a></li>
                            </ul>
                        </div> 
                        <div class="clear" style="clear:both;"></div>
                        <div class="manage_yuyue" >
                            <div class="manage_search"> 
                          <?php echo form_open('manage/yiyuan/comment/'.$acuid); ?>   
                            	<ul>  
	...
	$(function () {
        ...
        $("#deltall").click(function () { 
            $(".manage_yuyue_form :checkbox:checked").each(function () {
                ...
                $.get("http://www.meilimei.com/manage/yiyuan/cdel/" + $(this).val(), {
                    id: $(this).val()
