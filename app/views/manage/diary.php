    ...
    <div class="manage_center_right">
                        ...
                        <div class="manage_search"><form method="get" action="<?php echo base_url('manage/diary'); ?>">
                                <ul>
                                    ...
                                    <li>类型
									<select name="types">
										<option value="all" <?php echo $this->input->get('types')=='all'?'selected="selected"':'' ?> >全部</option>
										<option <?php echo $this->input->get('types')=='win'?'selected="selected"':'' ?> value="win">windows</option>
										<option <?php echo $this->input->get('types')=='nowin'?'selected="selected"':'' ?> value="nowin">非 windows</option>
									</select>
									</li>
                                    ...
                                    <li>推荐
										...
										<option <?php echo $this->input->get('is_front')=='全部'?'selected="selected"':'' ?> >全部</option>
										<option <?php echo $this->input->get('is_front')=='is_front'?'selected="selected"':'' ?>  value="is_front">是</option>
										<option <?php echo $this->input->get('is_front')=='no_front'?'selected="selected"':'' ?> value="no_front">否</option>
										</select>
									</li>
