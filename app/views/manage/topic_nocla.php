    ...
    <div class="manage_center_right">
                    	<div class="question_nav">
                        	<ul>
                                ...
                                <li class="on"><a href="<?php echo site_url('manage/topic/nocla'); ?>">未分类</a></li>
                        	...
                        	<div class="manage_yuyue_form">
								...
								foreach($results as $row){
								   $tmp = unserialize($row->type_data); 
									echo '<ul>
                                	<li style="width:30%"><a href="'.base_url('manage/topic/detail/'.$row->weibo_id).'" >'.$tmp['title'].'</a></li>
                                  	<li style="width:25%">'.$row->content.'</li><li style="width:10%"><a href="'.site_url('manage/users/detail/'.$row->uid).'">'.($row->alias!=''?$row->alias:$row->phone).'</a></li><li style="width:10%">'.$row->wsource.'</li>
