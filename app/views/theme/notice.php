                        ...
                        <div class="personal_information"> <?php echo form_open_multipart("",array('id' => 'reg'))?>
                        	<ul>
                            	<li>
                                    ...
                                    <div class="k2"><span> </span> <p><input type="radio" <?php echo  isset($notification[0]) && $notification[0]->new_ask?'checked="checked"':'' ?>  name="zixun" value="1" />打开  <input <?php echo isset($notification[0]) && $notification[0]->new_ask?'':'checked="checked"' ?> type="radio" name="zixun" value="0" />关闭</p></div>
                                </li>
                            	 
                                <li>
                                	<div class="k1" style="font-weight:normal"> 接收用户在同个咨询中追问的邮件提醒：</div>
                                    <div class="k2"><span></span><p><input type="radio" <?php echo isset($notification[0]) && $notification[0]->new_reply?'checked="checked"':'' ?> name="szixun" value="1" />打开  <input <?php echo isset($notification[0]) && $notification[0]->new_reply?'':'checked="checked"' ?> type="radio" name="szixun" value="0" />关闭</p> </span></div>
                                </li>
                                 <li>
