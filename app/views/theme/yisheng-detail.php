...
<script src="http://static.meilimei.com.cn/public/js/jquery.raty.js"></script><link rel="stylesheet" href="http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css" />
    ...
    <div class="listinfo"><ul><li><strong>机构</strong>：<?php echo $yisheng['company'] ?></li><li><strong>简介</strong>：<?php echo $yisheng['introduce'] ?></li><li><strong>擅长</strong>：<?php echo $yisheng['skilled'] ?></li></ul><div id="askinfo" class="askinfo" style="display: none;"><h3>向该医生提问      <span>可以输入50个字</span></h3><?php echo form_open_multipart("",array('id' => 'askform')) ?>
   ...
   <input type="file" name="attachPic"/></li></ul></div><input type="submit" value="" class="subqus" /><div style="clear:both"></div></form></div><div class="newsanass"><h3 style="padding:10px 0px;color:#db1765;border-bottom:dashed 1px #CCCCCC">评论</h3><ul>
    <?php
