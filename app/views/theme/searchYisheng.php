<link rel="stylesheet" type="text/css" href="http://static.meilimei.com.cn/public/css/new.css"><div style="padding:0px 0px 10px">
        ...
        <dl class="clearfix">
        	<dt>城市筛选 </dt>
        	<dd class="city_list"  style="height:98px;"><a href="<?php echo $citylink ?>">不限</a>
            <?php
			...
			' 西安' ,'台州' ,'威海' , '延吉' ,'邯郸' ,'绍兴' ,'宜昌' ,'保定' ,'泰安' ,'通化' ,'衡水','牡丹江'
			);
			Gcity($citylink,$arr);
        ...
        <?php 
            ...
            <dt>
            	<a href="'.base_url().'yishengDetail/'.$r['user_id'].'" target="_blank">
            		<img style="height:84px;width:84px;background:url('.$r['thumbUrl'].')" src="http://static.meilimei.com.cn/public/images/blank.gif" class="border">
            	</a>
            </dt>
            <dd class="doc_tit">
            	<b>
           ...
           <dd style="display: none;"><ul><li><a href="'.base_url().'yishengDetail/'.$r['user_id'].'"><img  src="http://static.meilimei.com.cn/public/images/onlinec.png" /></a></li><li><a href="'.base_url().'yishengDetail/'.$r['user_id'].'"><img src="http://static.meilimei.com.cn/public/images/yuyueon.png" /></a></li></ul></dd>
          </dl> ';
			}			
		 ?> 
