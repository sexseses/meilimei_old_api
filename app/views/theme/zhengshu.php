<link rel="stylesheet" type="text/css" href="http://static.meilimei.com.cn/public/css/personal_center.css" > <script type="text/javascript" src="<?php echo base_url() ?>public/js/ajaxfileupload.js"></script><div class="page_content933">
            	<div class="institutions_info">
                    ...
                    <div class="Personal_center_right">
                    	<div class="question_shortcuts">
                        	<ul>
                            	<li><a href="<?php echo site_url('user/info') ?>">医师基本资料</a></li><li class="selected"><a href="<?php echo site_url('user/zhengshu') ?>">证书扫描件</a></li><li><a href="<?php echo site_url('user/ysablum') ?>">案例图集</a></li><li><a href="<?php echo site_url('user/changepass/2') ?>">修改密码</a></li>
                            </ul>
                        </div>
		...
		function ajaxFileUpload()
	{
		...
		(
			{
				url:'<?php echo site_url() ?>jquery/upsaomiao',
				secureuri:false,
...
$(function(){ 
  ...
  $("#delete").click(function(){
	  ...
	  $.get('<?php echo site_url() ?>jquery/delsaomiao.html', {"id":qry }, function(data) { 
