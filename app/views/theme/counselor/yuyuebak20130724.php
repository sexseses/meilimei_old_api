<link rel="stylesheet" type="text/css" href="http://static.meilimei.com.cn/public/css/personal_center.css" ><link rel="stylesheet" type="text/css" href="http://static.meilimei.com.cn/public/css/thickbox.css" ><link rel="stylesheet" type="text/css" href="http://static.meilimei.com.cn/public/css/thickbox.css" ><script type="text/javascript" src="http://static.meilimei.com.cn/public/js/wen.js"></script><div class="page_content933">
                        ...
                        <div class="manage_yuyue" >
                        	<div class="yuyue_form">
								...
								foreach($data as $row)
								{
                                    ...
                                    <li class="Vertical08 Vertical08d">'.($row['comment']==''?'<a href="'.site_url('counselor/beizhu').'?height=120&width=320&dataid='.$row['id'].'" title="添加备注" class="thickbox">备注</a>':$row['comment']).'</li>
    ...
    numTd.click(function() {     
      ...
      <script type="text/javascript">
       var orgStr =  $(".Vertical08d").text();
       $(function(){
           var newStr='';
           var strLength = 18;
           var obj =null;
           if($(".Vertical08d").text().length > strLength) {
        	   newStr = $(".Vertical08d").text().substring(0,strLength);
        	   $(".Vertical08d").html($(".Vertical08d").text(newStr+'...').html()+"<div style='clear:both'></div><div class='all_show' style='text-align:left;'>更多	</div>")
           }
       })
       $(".all_show").live("click",function(){
            var str = orgStr;
            $(".Vertical08d").html(orgStr+"<div style='clear:both'></div><div class='all_hidden' style='text-align:left;'>隐藏	</div>");
       });
       $(".all_hidden").live("click",function(){
           var newStr='';
           var strLength = 18;
           if($(".Vertical08d").text().length > strLength) {
        	   newStr = $(".Vertical08d").text().substring(0,strLength);
