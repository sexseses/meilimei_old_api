...
<body>
	...
	<div class="wapper">
        ...
        <div class="login" style=" overflow: hidden; height: auto;"><a id="reg"></a><a id="login"></a>
            <div class="login_left"><?php echo form_open("user/logChecknocap",array('id' => 'login'))?>
                <ul>
                    <li class="on">已成为美丽美会员，快速登录</li>
                    <li><input id="username" type="text" value="" name="username" autofocus  required  placeholder="用户名（邮箱账号）"></li>
                    <li><input type="password" name="password" required value="" placeholder="请输入密码"></li>
					<li><span id="bug"></span></li>
					<li class="loginbutton"><input type="submit" class="button1 gray"  value="立即登录"></li>
        ...
        <div class="about">
            <div class="about_main"><a id="about"></a><strong>&nbsp;关于我们</strong><br><span>&nbsp;&nbsp;美丽美是一个专注于美丽的在线平台，提供给广大闺蜜们最in最hot的资讯和互动空间，想更多的了解我们？快去苹果AppStore或各大安卓市场<br>&nbsp;&nbsp;搜索“美丽神器”下载看看吧！</span><br>【活动】<br><span>&nbsp;&nbsp; 所有关于美丽的周活动、月活动、季活动都在美丽神器第一时间更新，第一手获得信息赢得美丽神器活动终生免费券</span><br>【秘密】<br><span>&nbsp;&nbsp;你在这里的一切活动都将被保密</span><br>【在线闺蜜】<br><span>&nbsp;&nbsp;寻找和你一样经历的MM，成为最亲密的闺蜜</span><br><br><span>&nbsp;&nbsp;如遇到问题，请与我们联系：<br>&nbsp;&nbsp;电话：400-6677-245<br>&nbsp;&nbsp;Q Q：747242966<br>&nbsp;&nbsp;邮件： hi&lt;a&gt;meilimei.com</span></div>
        </div>
