   ...
   private function Npost($ac){
    ...
    public function getQiniuImagewater($file, $width = 360, $os = 'android'){
        switch ($width) {
			...
			case 480:
				if ($os == 'android') {
					return $this->fileUrl . $file . "?imageView2/3/w/480/q/75/format/jpg%7Cwatermark/1/image/aHR0cDovLzd4a2RpOC5jb20xLnowLmdsYi5jbG91ZGRuLmNvbS93aXM0Mi0xLnBuZw==/dissolve/20/gravity/Center/ws/1";
				} else {
					return $this->fileUrl . $file . "?imageView2/3/w/480/q/75/format/jpg%7Cwatermark/1/image/aHR0cDovLzd4a2RpOC5jb20xLnowLmdsYi5jbG91ZGRuLmNvbS93aXM0Mi0xLnBuZw==/dissolve/20/gravity/Center/ws/1";
				}
				break;
            case 640:
                if ($os == 'android') {
                    return $this->fileUrl.$file."?imageView2/2/w/640/q/100/format/jpg%7Cwatermark/1/image/aHR0cDovLzd4a2RpOC5jb20xLnowLmdsYi5jbG91ZGRuLmNvbS93aXM2NC0xLnBuZw==/dissolve/20/gravity/Center/ws/1";
                } else {
                    return $this->fileUrl.$file."?imageView2/2/w/640/q/100/format/jpg%7Cwatermark/1/image/aHR0cDovLzd4a2RpOC5jb20xLnowLmdsYi5jbG91ZGRuLmNvbS93aXM2NC0xLnBuZw==/dissolve/20/gravity/Center/ws/1";
                }
            case 1242:
