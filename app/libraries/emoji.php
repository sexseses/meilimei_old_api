...
class emoji
{
    ...
    public function mb_serialize($serial_str) {
        return serialize(str_replace($this->emoji_unicode,$this->emoji_str,$serial_str));
    }

    public function mb_unserialize($serial_str) {
        $out = preg_replace('!s:(\d+):"(.*?)";!se', "'s:'.strlen('$2').':\"$2\";'", $serial_str );
        return str_replace($this->emoji_str,$this->emoji_unicode,unserialize($out));
    }

    public function emoji2str($emoji) {
        return str_replace($this->emoji_unicode,$this->emoji_str,$emoji);
    }

    public function str2emoji($str) {
        return str_replace($this->emoji_str,$this->emoji_unicode,$str);
    }
}