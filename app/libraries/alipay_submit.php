...
class alipay_submit {
	...
	function buildForm($para_temp, $gateway, $method, $button_name, $aliapy_config) {
		...
		$sHtml .= '<div style="width:500px; margin:50px auto; border:solid 1px  #FFD5A6;font-size:14px; background:#FFF7E1; padding:30px;"><p>系统将自动跳转到支付宝处理页面，如果没有正常跳转请点击下面按钮</p><br>' . "\n";
		//submit按钮控件请不要含有name属性
		$sHtml = $sHtml . "<input type='submit' value='" . $button_name . "'></div></form>";
