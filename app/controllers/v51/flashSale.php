...
class flashSale extends MY_Controller {
        ...
        if(!empty($fs_rs)){
            ...
            if(!empty($fs_rs['pro_arr'])){
                ...
                foreach ($tehui_info as &$r) {
                    if(!strstr($r['image'],"http://pic") && strpos($r['event_content'], 'clouddn.com') === false) {
    ...
    public function getflashSaleList(){
        ...
        $fields = " id,city,type,type_id,begin,end,lbanner,title,discount,vbuy,lbanner_key, banner_key";
