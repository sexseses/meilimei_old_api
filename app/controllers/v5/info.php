...
class info extends MY_Controller {
    ...
    function softInfoXml(){
        ...
        if($os == 'ios'){
            echo json_encode(array('state'=>'000','v'=>'1.8.3', 'desc'=>'新版本APP发布了,快去下载吧～！','open'=>0, 'open2'=>1, 'open3'=>0));
        }
        else {
...
4.[优化] 个人中心订单部分调整.', 'path' => 'http://www.meilimei.com/m/meilishenqi.apk')));
 ...
 请点击确定在线升级，如果升级失败，请到http://www.meilimei.com/下载最新版本(安装包大小：10.38MB)','path'=>'http://www.meilimei.com/m/meilimei.apk')));
	...
	function faces($param = '') {
		...
		$files = $this->getAllFiles($_SERVER['DOCUMENT_ROOT'].'/images/faces/');
		...
		foreach ($files as $r) {
			...
			$result['data'][] = array (
				'name' => $name, 'url' => 'http://www.meilimei.com/images/faces/'. urlencode($r), 'code'=> $encode);
		}
