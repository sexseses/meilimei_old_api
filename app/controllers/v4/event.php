...
class event extends MY_Controller {
    ...
    public function getflashSaleByid(){
        ...
        $fs_pr_sql = "select * from flash_sale_tehui where 1=1 and fs_id = ? order by level DESC limit $offset,10";
    ...
    public function getEventDetail(){
        ...
        if(intval($event_id) > 0){
            $this->eventDB->select('event_title, event_pic, event_context as event_content, event_score, begin_time, end_time');
