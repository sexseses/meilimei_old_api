		...
		if ($id) {
			...
			if (!empty ($tmp)) {
                ...
                if ($result['data']['image'] != '') {
                    if(strpos($result['data']['image'], 'http://pic.') === 0 && strpos($result['data']['image'], 'clouddn.com') === 0) {
                        $images[] = $result['data']['image'] = 'http://tehui.meilimei.com/static/' . $result['data']['image'];
                    }
                }
                if ($result['data']['image1'] != '') {
                    if(strpos($result['data']['image1'], 'http://pic.') === 0 && strpos($result['data']['image1'], 'clouddn.com') === 0) {
                        $images[] = $result['data']['image1'] = 'http://tehui.meilimei.com/static/' . $result['data']['image1'];
                    }
                }
                if ($result['data']['image2'] != '') {
                    if(strpos($result['data']['image2'], 'http://pic.') === 0 && strpos($result['data']['image2'], 'clouddn.com') === 0) {
