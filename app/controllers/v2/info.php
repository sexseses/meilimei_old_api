...
class info extends MY_Controller {
    ...
    function softInfoXml(){
        ...
        if($os == 'ios'){
            echo json_encode(array('state'=>'000','v'=>'1.7.5', 'desc'=>'新版本APP发布了,快去下载吧～！','open'=>0));
        }
        else {
            echo json_encode(array('state' => '000', 'data' => array('version' => 26, 'versionName' => '3.15', 'description' => '3.15版本更新如下:
[7.45MB/3.15ver/2015-04-23]
[※新增※]
1.微信支付;
2.主界面右上角新增消息提醒入口;
3.闪购分享;
[※优化※]
1.优化部分界面细节;
2.根据用户反馈,修正BUG;', 'path' => 'http://www.meilimei.com/m/meilishenqi.apk')));
        }
    }
