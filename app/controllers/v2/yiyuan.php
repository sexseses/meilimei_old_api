...
class yiyuan extends MY_Controller
{
    ...
    public function search($param = '')
    {
        ...
        $sql = "SELECT company.id,company.name,company.tel,company.shophours,company.department,company.address,company.city,users.suggested as verify,company.userid,users.grade, users.created ";
        $forder = '';
...
//        }
        ...
        $sql .= ' ORDER BY ' . $forder . ' users.rank_search DESC ,users.id ASC';
