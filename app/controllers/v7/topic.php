			...
			if (!empty ($tmp)) {
				...
				if ($tmp[0]['type'] == 1 and !empty ($ptmp)) {
					if(empty($tmp[0]['imgfile'])) {
						...
						$result['data']['url'] = $this->fileUrl.$tmp[0]['imgfile'];
